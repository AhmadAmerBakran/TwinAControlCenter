...
UninstallDisplayIcon={app}\assets\TwinA-{#AppVersion}.ico
SetupLogging=yes
...
[Icons]
Name: "{autoprograms}\TWIN A Control Center"; Filename: "{app}\launcher\{#AppExeName}"; Parameters: "--open"; WorkingDir: "{app}\launcher"; IconFilename: "{app}\assets\TwinA-{#AppVersion}.ico"
Name: "{autoprograms}\TWIN A - Configure iPad Access"; Filename: "{app}\launcher\{#AppExeName}"; Parameters: "--setup"; WorkingDir: "{app}\launcher"; IconFilename: "{app}\assets\TwinA-{#AppVersion}.ico"
Name: "{autoprograms}\TWIN A - Help Center"; Filename: "{app}\server\wwwroot\help\index.html"; IconFilename: "{app}\assets\TwinA-{#AppVersion}.ico"
Name: "{autoprograms}\TWIN A - Read Me"; Filename: "{app}\README.md"; IconFilename: "{app}\assets\TwinA-{#AppVersion}.ico"
Name: "{autodesktop}\TWIN A Control Center"; Filename: "{app}\launcher\{#AppExeName}"; Parameters: "--open"; WorkingDir: "{app}\launcher"; IconFilename: "{app}\assets\TwinA-{#AppVersion}.ico"; Tasks: desktopicon
